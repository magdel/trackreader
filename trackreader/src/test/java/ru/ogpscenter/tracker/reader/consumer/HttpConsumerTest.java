...
public class HttpConsumerTest {
    ...
    public void testCreateFullParametersArray() throws Exception {
        ArrayList<NameValuePair> array = HttpConsumer.createParametersArray(new LocationRecord(1L, "2", "ime", DateTime.parse("2010-06-30T01:20"),
                60.55, -120.1, 3.33, 155, true, true));
        assertEquals(array.toString(), "[eventId=1, deviceId=2, dttm=1277846400000, imei=ime, lat=60.550000, lon=-120.100000, spd=3.3, crs=155]");
    }
    ...
    public void testCreateMinParametersArray() throws Exception {
        ...
        assertEquals(array.toString(), "[eventId=1, deviceId=2, dttm=1277846400000, imei=ime]");
    }
