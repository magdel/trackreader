...
public class StringLocationRecordMapper implements Function<String, Optional<LocationRecord>> {
    ...
    public Optional<LocationRecord> apply(String trackString) {
        try {
            Optional<LocationRecord> converted = convertMt90(trackString, idGenerator);
            if (converted.isPresent()) {
                return converted;
            }
            return convertTk102(trackString, idGenerator);
        } catch (Exception ex) {
    ...
    private static Optional<LocationRecord> convertMt90(String trackString, IdGenerator idGenerator) {
    ...
    private static Optional<LocationRecord> convertTk102(String trackString, IdGenerator idGenerator) {
        //STX,Id-112233,$GPRMC,112842.000,A,6000.5274,N,03021.3429,E,0.00,0.00,241214,,,A*6C,F,,imei:013226008424265,03,23.0,Battery=70%,,0,250,02,1E82,173D;36
